# Base10 · Helicon Consensus Grade

Helicon Industries Seed → Series A consensus-deal probability analysis. Internal Base10 use only.

**Live URL**: `https://ade-B10.github.io/helicon-consensus-grade/`
...
2. Enter the team password (saved in 1Password under "Base10 · Helicon Consensus Grade")
...
```bash
cd /Users/ade/Desktop/Urizen/helicon-consensus-grade-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Helicon_Consensus_Grade.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · Helicon Consensus Grade ($(date +%Y-%m-%d))"
git push
```
