...
#
# Usage:
#   1. Put the updated unencrypted file at source/Helicon_Consensus_Grade.html
...
SOURCE_FILE="source/Helicon_Consensus_Grade.html"
OUTPUT_FILE="index.html"
LABEL="Base10 · Helicon Consensus Grade"
INSTRUCTIONS="Enter the password to access Base10 · Helicon Consensus Grade."
REMEMBER_DAYS=14
...
if [ ! -f "$SOURCE_FILE" ]; then
  ...
  echo "  mkdir -p source"
  echo "  cp /Users/ade/Desktop/Urizen/Helicon_Consensus_Grade.html source/"
  echo ""
  exit 1
fi
...
sed -i.bak "s|<title>Protected Page</title>|<title>Base10 · Helicon Consensus Grade</title>|" "$OUTPUT_FILE"
...
echo "  git commit -m \"Refresh Base10 · Helicon Consensus Grade ($(date +%Y-%m-%d))\""
echo "  git push"
echo ""
